...
describe('NgxMatTimepickerAdapter', () => {
  describe('parseTime', () => {
    ...
    it('should parse from string and return as DateTime', () => {
      ...
      expect(NgxMatTimepickerAdapter.parseTime('11:00', { locale }).hour).toBe(
        expectedHour,
      );
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00', { locale }).minute,
      ).toBe(expectedMinute);
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00 Am', { locale }).hour,
      ).toBe(expectedHour);
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00 Am', { locale }).minute,
      ).toBe(expectedMinute);
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00 am', { locale }).hour,
      ).toBe(expectedHour);
      ...
      expect(NgxMatTimepickerAdapter.parseTime('23:00', { locale }).hour).toBe(
        expectedHour,
      );
      expect(
        NgxMatTimepickerAdapter.parseTime('23:00', { locale }).minute,
      ).toBe(expectedMinute);
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00 Pm', { locale }).hour,
      ).toBe(expectedHour);
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00 Pm', { locale }).minute,
      ).toBe(expectedMinute);
      expect(
        NgxMatTimepickerAdapter.parseTime('11:00 pm', { locale }).hour,
      ).toBe(expectedHour);
    ...
    it('should parse time from latn to arab number', () => {
      ...
      expect(
        NgxMatTimepickerAdapter.parseTime(arabicTime, {
          locale: arabLocale,
  ...
  describe('formatTime', () => {
    it('should return time in 24-hours format', () => {
      ...
      expect(NgxMatTimepickerAdapter.formatTime('11:00 pm', { format })).toBe(
        '23:00',
      );
      expect(NgxMatTimepickerAdapter.formatTime('18:10', { format })).toBe(
        '18:10',
      );
    });
    ...
    it('should return time in am/pm format', () => {
      ...
      expect(NgxMatTimepickerAdapter.formatTime('23:00', { format })).toBe(
        '11:00 PM',
      );
      expect(NgxMatTimepickerAdapter.formatTime('12:20 am', { format })).toBe(
        '12:20 AM',
      );
      expect(
        NgxMatTimepickerAdapter.formatTime('12:20 am', { format: 33 }),
      ).toBe('12:20 AM');
    });

    it('should return Invalid Time message when provide invalid time', () => {
      expect(NgxMatTimepickerAdapter.formatTime(null, { format: 12 })).toBe(
        'Invalid Time',
      );
      expect(
        NgxMatTimepickerAdapter.formatTime(undefined, { format: 24 }),
      ).toBe('Invalid Time');
      expect(NgxMatTimepickerAdapter.formatTime('', { format: 24 })).toBe(
        'Invalid Time',
      );
    });
  });
  ...
  describe('isTimeAvailable', () => {
    ...
    it('should return true', () => {
      ...
      let isAvailable = NgxMatTimepickerAdapter.isTimeAvailable(
        '11:12 am',
        min,
      );
    ...
    it('should throw an Error', function () {
      ...
      try {
        ...
        expect((e as Error).message).toBe(
          `Your minutes - 43 doesn't match your minutesGap - ${minutesGap}`,
        );
      }
    });
  });
  ...
  describe('formatHour', () => {
    ...
    it('should return 10', () => {
      expect(
        NgxMatTimepickerAdapter.formatHour(10, 12, NgxMatTimepickerPeriods.AM),
      ).toBe(10);
    });

    it('should return 22', () => {
      expect(
        NgxMatTimepickerAdapter.formatHour(10, 12, NgxMatTimepickerPeriods.PM),
      ).toBe(22);
    });
  ...
  describe('fromDateTimeToString', () => {
    ...
    it('should return time as string in 24-hours format', () => {
      ...
      expect(NgxMatTimepickerAdapter.fromDateTimeToString(dateTime, 24)).toBe(
        expected,
      );
    });
    ...
    it(`should convert time from 'arab' numbering system to 'latn' and return as string`, () => {
      ...
      const dateTime = DateTime.fromObject(
        { hour: 11, minute: 11 },
        { numberingSystem: 'arab', locale: 'ar-AE' },
      );
